...
if __name__ == '__main__':
    ...
    """patch coordinates for 23.03.2022"""
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[15, 105, 0, 75], patch_name='cross_first_first')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[15, 105, 90, 175], patch_name='cross_first_middle')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[15, 105, 178, -1], patch_name='cross_first_last')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[125, 235, 0, 90], patch_name='cross_middle_first')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[125, 235, 85, 181], patch_name='cross_middle_middle')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[125, 235, 179, -1], patch_name='cross_middle_last')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[240, -1, 0, 85], patch_name='cross_last_first')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[230, -1, 85, 180], patch_name='cross_last_middle')
    generate_image_patches(args.input_dir, args.out_dir, coordinates=[240, -1, 180, -1], patch_name='cross_last_last')
